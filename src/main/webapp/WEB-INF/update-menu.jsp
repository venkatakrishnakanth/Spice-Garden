...
<form action="update_menu" method="POST">
  ...
  <input type="password" name="password" id="" placeholder="password" class="email">
    
  <label for="">Item</label>
  <input type="text" name="item" id="" placeholder="item to be updated" class="pass">
  
  <label for="">Cost</label>
  <input type="text" name="price" id="" placeholder="new price" class="pass">
    
  <button type="submit" value="Update Price">UPDATE</button>
